 ...
 */
final class Version20240311092617 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE candidat ADD user_id INT NOT NULL, DROP user');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE candidat ADD user BIGINT NOT NULL, DROP user_id');
    }
}
